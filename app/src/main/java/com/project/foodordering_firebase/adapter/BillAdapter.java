...
public class BillAdapter extends FirebaseRecyclerAdapter<Bill, BillAdapter.myViewHolder> {
    Context mContext;
    String mUserName;
    /**
    ...
    public BillAdapter (Context context, FirebaseRecyclerOptions<Bill> options, String username) {
        super(options);
        mContext = context;
        mUserName = username;
    }

    public BillAdapter(FirebaseRecyclerOptions<Bill> options) {
        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull myViewHolder holder, int position, @NonNull Bill model) {
        holder.bId.setText(model.getBillID());
        holder.bDate.setText(model.getDatetime());
    ...
    class myViewHolder extends RecyclerView.ViewHolder{
        ...
        public myViewHolder(@NonNull View itemView) {
            ...
            recyclerView = itemView.findViewById(R.id.rvhistoryorder);
        }
    }
}
