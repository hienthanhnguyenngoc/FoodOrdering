package com.project.foodordering_firebase.ViewPager;
...
public class ViewPagerAdapter extends PagerAdapter {
    ...
    Integer[] images = {R.drawable.poterquangcao1,R.drawable.poterquangcao2,R.drawable.poterquangcao3,R.drawable.posterquangcao5};
